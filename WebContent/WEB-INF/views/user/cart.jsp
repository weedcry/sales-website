           ...
           <div class="wrap">
           		  <c:if test="${check != 0}">
					      ...
					      <div class="container">
					        <h1>GIỎ HÀNG</h1>
					        <ul class="head flex">
					          <li style="padding-right:100px">Giá bán</li>
					          <li  style="padding-right:60px">Số lượng</li>
					          <li style="padding-right:110px">Tổng giá</li>
					        </ul>
					        <c:forEach var="h" items="${dh}">
						          <ul class="content flex j-between a-center">
						          <li><img src="${h.anh}" alt="" /></li>
						          <li><a href="user/single.htm?id=${h.mamathang}">${h.tenmathang}</a></li>
						          <li style="margin-left: 110px"><strong><fmt:formatNumber type="number" maxFractionDigits="3" value="${h.giaban}"  /> VNĐ</strong></li>
	<%-- 					          <li>
						            <span class="sub">-</span
						            ><input name="number" type="text" value="${h.soluong}" /><span class="plus"
						              >+</span
						            >
						          </li> --%>
						          <li style="margin-left: 50px">
						          	<input type="number" value="${h.soluong}" min="0" />
						          </li>
						          
						          <li style="margin-right: 20px"><fmt:formatNumber type="number" maxFractionDigits="3" value="${h.soluong*h.giaban}"/> VNĐ</li>
						          <li><a href="user/deletecart.htm?id=${h.mamathang}">xóa</a></li>
						        </ul>
							</c:forEach>
							<div style="text-align: center">
									<div class="sub-total flex">
										<span>Tổng Giá:</span><strong><fmt:formatNumber type="number" maxFractionDigits="3" value="${tong}"  /> VNĐ</strong>
									</div >
									<div class="sub-total flex" >
										<span style="margin-right: 50px">Phí Ship:</span>
										<strong>0 VNĐ</strong>
									</div >
							        <div class="sub-total flex" style="text-align: center">	
							          	<span>Thành tiền:</span><strong><fmt:formatNumber type="number" maxFractionDigits="3" value="${tong}"  /> VNĐ</strong>
							        </div>						
							</div>

					        <div class="payment flex">
					          <button><a href="user/index.htm">Mua tiếp</a></button>
					          <button><a href="user/shopping.htm">ĐẶT HÀNG</a></button>
					        </div>
					      </div>
				   		 </div>
				     </c:if>
			<c:if test="${check == 0}">
			    <h4 class="title">Shopping cart is empty</h4>
    	     	<p class="cart">You have no items in your shopping cart.<br>Click<a href="user/index.htm"> here</a> to continue shopping</p>			
			</c:if>   		    
    	   </div>
    	</div>
